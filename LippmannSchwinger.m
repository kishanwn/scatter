# This code is from https://github.com/Forgotten/Lippmann_Schwinger/tree/master and modified to add noise to the input and solve
...
classdef LippmannSchwinger
    ...
    methods
        % constructor
        function LS = LippmannSchwinger(x,y,omega,nu,a,rand_noise_nu)
            % x is a vector
            % y is a vector 
            % omega is a real
