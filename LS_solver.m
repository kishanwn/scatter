# This code is from https://github.com/Forgotten/Lippmann_Schwinger/tree/master
# This modified code has been run on octave to generate the raw data 
...
nu_ = LS.nu;
qname = ["data/q" , num2str(i) , ".mat"]
save('-v7', qname, "nu_")

realu = real(u);
qname = ["data/real" , num2str(i) , ".mat"]
save('-v7', qname, "realu")

imagu = imag(u);
qname = ["data/imag" , num2str(i) , ".mat"]
save('-v7', qname, "imagu")
